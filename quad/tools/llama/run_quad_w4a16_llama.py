...
from quad.models.llama.quad_tunable_w4a16_llama import QuadTunableLlamaConfig, QuadTunableLlamaForCausalLM
import logging
...
def get_llama(args):
    config: QuadTunableLlamaConfig = QuadTunableLlamaConfig.from_pretrained(args.model)
